...
public class AutoEarphoneRemove extends AutoItemActivity implements OnClickListener {

  private Button falBtn;
  private TextView earText;
  private AudioManager audioManager;
  private boolean mIsHeadsetPlugged = false;
  private static final String TAG = "AutoEarphoneRemove";
  ...
  public void onReceive(Context context, Intent intent) {				
    ...
    if(action.equals(Intent.ACTION_HEADSET_PLUG)){
      ...
      else 
      {
      	...
      	{
           if(bFlagAutoTest)
              openActivity(getTestItemActivityIdByClass(AutoEarphoneRemove.this)+1);
           else
              setTestSuccessed(getTestItemActivityIdByClass(AutoEarphoneRemove.this));
           finish();
        }
      }
    }
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.auto_earphone_remove);
    
    earText = (TextView)findViewById(R.id.earphone_remove);

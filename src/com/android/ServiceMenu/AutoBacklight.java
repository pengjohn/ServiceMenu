...
public class AutoBacklight extends AutoItemActivity implements OnClickListener{

  private static final int TEST_BACKLIGHT_ON = 1;
  private static final int TEST_BACKLIGHT_OFF = 2;
  private static final int TEST_MESSAGE_EVENT = 0x150;
  private static final int BACKLIGHT_ON_DELAY = 1000;
  private static final int BACKLIGHT_OFF_DELAY = 1000;  
  private Button falBtn,sucBtn;
  private static final String FILE_KEY_BACKLIGHT = "/sys/class/leds/button-backlight/brightness";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.auto_backlight);
  ...
  public void onResume() {
    super.onResume();
    writeFile(FILE_KEY_BACKLIGHT, 100);
    ...
    msg2.arg1 = TEST_BACKLIGHT_OFF;
    myHandler.sendMessageDelayed(msg2, BACKLIGHT_ON_DELAY);    
  }
  
  @Override
  protected void onPause() {

    writeFile(FILE_KEY_BACKLIGHT, 0);
      ...
      case TEST_MESSAGE_EVENT:
      {
  	    ...
  	    else
    	  {
    	  	writeFile(FILE_KEY_BACKLIGHT, 0);
    			Message msg2 = new Message();
    			msg2.what = TEST_MESSAGE_EVENT;
	    		msg2.arg1 = TEST_BACKLIGHT_ON;
  	  		myHandler.sendMessageDelayed(msg2, BACKLIGHT_OFF_DELAY);
    	  }
    		break;
    }        			
      default:
